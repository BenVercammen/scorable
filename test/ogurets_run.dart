...
import 'features/step_definitions/scorable.dart' as scorable;
...
void main(args) async {
  var def = new OguretsOpts()
    ..feature('test/features/manage_participants_of_scorable.feature')
    ..debug()
    ..step(scorable.Game)..step(scorable.ScorableStepDefinitions)
  ;
